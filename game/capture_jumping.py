...
class Capture:
    def __init__(self,window_title):
        ...
        self.window = pygetwindow.getWindowsWithTitle(self.window_title)
        self.location = [0,0]
    def active(self):
        pywinauto.application.Application().connect(handle=self.window[0]._hWnd).top_window().set_focus()
